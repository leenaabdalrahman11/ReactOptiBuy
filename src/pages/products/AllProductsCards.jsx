...
function AllProductsCards({ product }) {
  ...
  const avgRating = reviews.length ? avgRatingNumber.toFixed(1) : null;
      ...
      <CardContent>
        <CardActions disableSpacing className={styles.cardActions}>
          <Typography variant="body2" color="text.secondary">
            ...
            <span className={styles.newPrice}>${product.priceAfterDiscount}</span>
          </Typography>
